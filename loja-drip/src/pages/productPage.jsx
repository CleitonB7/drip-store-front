...
import ProductListingList from "../components/Abaproductos/ProductListingList";
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 px-4 sm:px-6 md:px-10 py-6 w-full">
      <aside className="w-full lg:w-70 shrink-0">
        <h3 className="text-gray-700 text-base font-semibold mb-4">Filtrar por:</h3>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="h-10 border border-gray-300 rounded px-3 text-sm focus:ring-1 focus:ring-pink-500 outline-none"
            >
